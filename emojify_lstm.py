...
def Emojify_V2(input_shape, word_to_vec_map, word_to_index):
    ...
    Emojifier-V2 model takes as input an array of shape (m, max_len) and outputs softmax probability vectors of shape (m, number of classes)
    Arguments:
    ...
    X = LSTM(128, return_sequences=True)(embeddings) # X = LSTM(units = ..., return_sequences= ...)(processed_inputs)
